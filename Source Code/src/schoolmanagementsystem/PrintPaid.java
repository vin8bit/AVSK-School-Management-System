 ...
 * @author Programmer
 */
public class PrintPaid extends javax.swing.JFrame {

    private String s1,s2,ss2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14;
    ...
    public PrintPaid() {
     ...
     private void printTextPane(String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8,String s9,String s10,String s11,String s12,String s13){
...
"                                    <td >\n" +
"                                        <div class=\"header\">\n" +
"                                            <h2>Lajpat Nagar,Delhi-110094</h2>\n" +
"                                        </div>\n" +
"                                    </td>\n" +
"                                </tr>\n" +
"                            </table>\n" +
...
"                                    <tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>S.No. </strong></td>\n" +
...
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s2+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Class</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s3+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
...
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Pay Date</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s7+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Tuition Fee</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s8+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Late Fee charge</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s9+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Annual Charge</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s10+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Other charge</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s11+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Admission Fee</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s12+"</strong></td>\n" +
"                                    </tr>\n" + 
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Total Fee</strong></td>\n" +
...
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Signature</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;____________________</strong></td>\n" +
"                                    </tr>\n" +
"                                   \n" +
"                                </table>\n" +"<table> <tr> <td><h4>Note : Fee must be deposited by the 10 days of every month.</h4>  </td> </tr>  </table>"+
"                            </div>\n" +
"                        </td>\n" +
"                    </tr>\n" +
"                </table> \n" +
...
"</html>");
    ...
    private void initComponents() {
        ...
        jLabel69.setText("Print Paid Student Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       MessageFormat header = new MessageFormat("AVSK Happy Public Sec School");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(!in.isEmpty()){
            ...
            try{    conn = DriverManager.getConnection(url,username,password);
                ...
                rs2=stm2.executeQuery("Select admission_no from "+monthYear+"");
                while (rs2.next()){
            ...
            if(flag5 == 1){
                try{
                    ...
                    stm2=conn.createStatement();
                    rs2= stm2.executeQuery("SELECT  *  FROM "+monthYear+" WHERE admission_no="+in+" ");
                    while(rs2.next()){
                        s1 = rs2.getString(1);
                        s2 = rs2.getString(2);
                        s3 = rs2.getString(3);
                    ...
                    conn.close();
                    printTextPane(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintPaid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
