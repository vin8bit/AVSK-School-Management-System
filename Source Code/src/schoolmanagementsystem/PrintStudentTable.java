 ...
 * @author Programmer
 */
public class PrintStudentTable extends javax.swing.JFrame {
    ...
    String columns[]={"R No","Ad No","Ad Date M n","Student Name","DOB Gender","F & M Name","Address","Class"};
    ...
    public PrintStudentTable() {
        ...
        jTable1.getColumnModel().getColumn(0).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(1).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(2).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(3).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(4).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(5).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(6).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(7).setCellRenderer(new PrintStudentTable.TextAreaRenderer());
        ...
        String sql = "SELECT * FROM students_table WHERE status='Active'";
        try{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Active Student Details");
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        MessageFormat header = new MessageFormat("Nav Yug Happy Public Sec School Student Details");
        ...
        if(evt.getStateChange()==ItemEvent.SELECTED){
            ...
            int occurrance = 0;   
                for(int row = 0; row < model.getRowCount(); row++) {
                        ...
                        if (jTable1.getValueAt(row, 7).equals(text) )
                            occurrance++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintStudentTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintStudentTable().setVisible(true);
            }
        });
    }
