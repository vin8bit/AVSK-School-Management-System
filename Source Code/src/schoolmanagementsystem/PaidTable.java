 ...
 * @author Programmer
 */
public class PaidTable extends javax.swing.JFrame {
    ...
    String columns[]={"S.No","Name","Class","Father Name","Roll No","Admn No","Date","Total Fee"};
    ...
    public PaidTable() {
        ...
        jTable1.getColumnModel().getColumn(0).setCellRenderer(new PaidTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(1).setCellRenderer(new PaidTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(2).setCellRenderer(new PaidTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(3).setCellRenderer(new PaidTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(4).setCellRenderer(new PaidTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(5).setCellRenderer(new PaidTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(6).setCellRenderer(new PaidTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(7).setCellRenderer(new PaidTable.TextAreaRenderer());
       ...
       jTable1.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        ...
        String sql = "SELECT * FROM "+monthYear+"";
        try{
			...
			resultSet= statement.executeQuery(sql);	
                            ...
                            while(resultSet.next()){   
                                ...
                                String s8 =resultSet.getString(13);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Paid Student Details "+monthYear);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        MessageFormat header = new MessageFormat("Nav Yug Happy Public Sec School Paid Student Details");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaidTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
