...
import static schoolmanagementsystem.PrintStudentTable.row;

/**
 *
 * @author Programmer
 */
public class PrintStaffTable extends javax.swing.JFrame {
    ...
    static String[] row = new String[8];
    String columns[]={"ID","Name","DOB & Gen","Join Date & M ","Fath & Husb Name","Qulification","Designation","Address"};
    ...
    public PrintStaffTable() {
        ...
        jTable1.getColumnModel().getColumn(0).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(1).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(2).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(3).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(4).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(5).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(6).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        jTable1.getColumnModel().getColumn(7).setCellRenderer(new PrintStaffTable.TextAreaRenderer());
        ...
        String sql = "SELECT * FROM staff_table WHERE status='Active'";
        try{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Active Staff Details ");

        class3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "","  Principal","  Vice – principal","  Senior Teacher","  Teacher","  Junior Teacher","  Computer Teacher","  Physical Education Teacher","  Art & Craft","  Drawing Teacher","  Music Teacher","  Senior Administration Executive","  Junior Accountant","  Office Assistant","  Data Entry Operator","  Receptionist","  Security Guard","  Peon","  Plumber","  Electrician ","  Others"}));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
         MessageFormat header = new MessageFormat("Nav Yug Happy Public Sec School Staff Details");
    ...
    private void class3ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_class3ItemStateChanged
        ...
        if(evt.getStateChange()==ItemEvent.SELECTED){
            ...
            for(int row = 0; row < model.getRowCount(); row++) {
                ...
                if (jTable1.getValueAt(row, 6).equals(text) )
                occurrance++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintStaffTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintStaffTable().setVisible(true);
            }
        });
    }
