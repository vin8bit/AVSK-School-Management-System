 ...
 * @author Programmer
 */
public class PrintStaff extends javax.swing.JFrame {

    /**
     * Creates new form PrintStaff
     */
    ...
    private void initComponents() {
        ...
        jLabel69.setText("Print staff Details");
    ...
    private void printTextPane(String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8,String s9,String s10,String s11,String s12,String s13,String s14){
...
"                                    <tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Staff ID </strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s1+"</strong></td>\n" +
"                                    </tr>\n" +
"                                    <tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Name</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+fullName+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Date of Brith</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s4+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Phone No</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s5+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Father's & Husband Name</strong></td>\n" +
...
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>E-Mail ID</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s8+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Qualification</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s9+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Designation</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s10+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Salary</strong></td>\n" +
"                                        <td style=\"word-break:break-all;style=\"color:#666\"><strong>:&nbsp;&nbsp;"+s11+"</strong></td>\n" +
"                                    </tr>\n" +
"									<tr>\n" +
"                                        <td style=\"padding-left: 10px; height: 15px;\" width=\"152\"><strong>Joining Date</strong></td>\n" +
...
"</html>");
        ...
        if(!in.isEmpty()){
            ...
            if(flag5 == 1){
                try{
                    ...
                    conn.close();
                    printTextPane(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintStaff().setVisible(true);
            }
        });
    }
